...
**Want to know what features are available vs Excalidraw+ (paid version)?**

👉 **[See detailed feature comparison](./FEATURES.md)** - Comprehensive guide showing what's included in this self-hosted version and what requires Excalidraw+.

**TL;DR:** This fork includes all core drawing and real-time collaboration features with self-hosted storage. Excalidraw+ adds AI features (text-to-diagram, diagram-to-code), cloud workspace, version history, and mobile apps.
